...
public class CommandEvent {
    ...
    private int offset;
    private YoshiBot yoshiBot;

    public CommandEvent(YoshiBot yoshiBot, MessageReceivedEvent event, String args, CommandClient client, String executor) {
